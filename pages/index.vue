<template>
  ...
  <section class="flex justify-between py-2 px-4 mb-10 bg-sky-100/5 ring-1 ring-zinc-700 rounded-md">
    <div>
      <h2 class="text-xl font-extrabold">Transactions</h2>
      <div class="text-zinc-500 dark:text-zinc-400">
        You have {{ incomeCount }} {{ incomeCount = 1 ? 'income' : 'incomes' }} and {{ expenseCount }} {{ expenses = 1 ?
          'expense' : 'expenses' }} this period
      </div>
    </div>
    <div>
